...
if __name__ == "__main__":
    ...
    mlp = MLPClassifier(solver="lbfgs",tol=1e-8,alpha=0.001,batch_size=64,learning_rate="adaptive",activation="logistic",max_iter=1000,shuffle=True,random_state=1,verbose=True,early_stopping=True,validation_fraction=0.2,hidden_layer_sizes=(256,))
