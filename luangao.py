...
if __name__ == "__main__":
    ...
    mlp = MLPClassifier(solver="lbfgs",tol=1e-8,alpha=0.001,max_iter=2000,shuffle=True,activation="relu",early_stopping=True,validation_fraction=0.2,random_state=12345,hidden_layer_sizes=(256,256))
